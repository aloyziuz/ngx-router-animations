        ...
        group([
            query(
                ...
                [
                    ...
                    animate(
                        "{{enterTiming}}s {{enterDelay}}s ease-in",
                        keyframes([
                            style({
                                opacity: "0.3",
                            ...
                            style({
                                transform:
                                    "translateX(50%) translateZ(-200px) rotateY(45deg)",
                                offset: 0.5,
                            }),
                            style({
                                opacity: "1",
                                transform:
                                    "translateX(0%) translateZ(00px) rotateY(0deg)",
                                offset: 1,
                            }),
                        ])
                    ),
                    ...
                    animate(
                        ...
                        keyframes([
                            style({
                                opacity: "0.2",
                                transform:
                                    "translateZ(-1000px) rotateY(-90deg)",
                                offset: 0,
                            }),
                            style({
                                opacity: "1",
        ...
        group([
            query(
                ...
                [
                    style({ opacity: "0", "transform-origin": "50% 50%" }),
                    animate(
                        "{{enterTiming}}s {{enterTiming}}s ease-in",
                        keyframes([
                            style({
                                opacity: "0.2",
                                transform: "translateZ(-1000px) rotateY(90deg)",
                    ...
                    animate(
                        ...
                        keyframes([
                            style({
                                opacity: "0.2",
                                transform:
                                    "translateZ(-1000px) rotateX(-90deg)",
                                offset: 0,
                            }),
                            style({
                                opacity: "1",
                    ...
                    animate(
                        ...
                        keyframes([
                            style({
                                opacity: "0.3",
                                transform:
                                    "translateX(200%) scale(.4) rotateY(65deg)",
                                offset: 0,
                            }),
                            style({
                                opacity: "1",
                    ...
                    animate(
                        ...
                        keyframes([
                            ...
                            style({
                                opacity: ".3",
                                transform:
                                    "translateX(-150%) scale(.4) rotateY(-65deg)",
                                offset: 1,
                            }),
                        ])
                    ),
                    ...
                    animate(
                        ...
                        keyframes([
                            style({
                                opacity: "0.3",
                                transform:
                                    "translateY(200%) scale(.4) rotateX(-65deg)",
                                offset: 0,
                            }),
                            style({
                                opacity: "1",
                    ...
                    animate(
                        ...
                        keyframes([
                            style({
                                opacity: "0.5",
                                transform:
                                    "translateZ(-500px) translateX(200%)",
                                offset: 0,
                            }),
                            style({
                                opacity: "0.5",
